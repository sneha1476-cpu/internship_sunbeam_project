...
>
  <div className="container-fluid">
    ...
    >
      {userRole === "admin"
        ? "Sunbeam Admin Portal"
        : "Sunbeam Student Portal"}
    </Link>
      ...
      <ul className="navbar-nav me-auto">
        ...
        {userRole === "student" && (
          <>
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/mycourse" style={{ color: "white" }}>
                My Courses
              </Link>
            </li>
          </>
        ...
        {userRole === "admin" && (
          <>
            <li className="nav-item">
              <Link className="nav-link" to="/manage-courses" style={{ color: "white" }}>
                Manage Courses
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/manage-videos" style={{ color: "white" }}>
                Manage Videos
              </Link>
            </li>
          </>
